...
def test_regression(variables):
    ...
    v4_baby = smf.ols(formula = "bwght ~ "+values, data=birth_weight)
    ...
    # Compute and print R^2 and RMSE
    yf_pred_reg2 = bb.predict(Xf_test)
    print('R-Squared: ', results_v4.rsquared.round(3))
    print('Training score: ', bb.score(Xf_train,yf_train).round(3))
    print('Testing Score: ', bb.score(Xf_test,yf_test).round(3))
